!(function () {
    ...
    L.Circle.include({
        ...
        updateMeasurements: function () {
            ...
            if (options.showArea) {
                var areaFormatter =
                    options.formatArea || L.bind(this.formatArea, this);
            ...
            if (options.showRadius) {
                var radiusFormatter =
                    options.formatDistance || L.bind(this.formatDistance, this);
                var radiusMeasurement = L.marker.measurement(
                    latLng,
                ...
                radiusMeasurement.addTo(this._measurementLayer);
            }
        },
    });
